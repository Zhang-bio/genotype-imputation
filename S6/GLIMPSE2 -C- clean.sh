...
vcftools --gzvcf /public/home/user/1.projects/9.bam_down/394_including22addseq_hardfiltered.snp.vcf.gz--max-missing 0.9 --maf 0.05 --hwe 1e-6 --minDP 3 --recode --recode-INFO-all --stdout | bgzip -f > hb_394_22_inds_mindp3.vcf.gz

bcftools index -c hb_394_22_inds_mindp3.vcf.gz 
    ...
    java -Xmx40g -jar "$beagle_jar" nthreads=16 gt="hb_394_22_inds_mindp3.vcf.gz" out="hb_394_22_inds_mindp3_beagle_z" impute=true
    
    # Define input files and output folders

    n_input_vcf="/public/home/user/1.projects/9.bam_down/22jc/hb_394_22_inds_mindp3_beagle_z.vcf.gz"
    n_output_folder="hb_all"
...
#for sample_size in "${samples[@]}"; do
    ...
    chunk_input_dir="/public/home/user/1.projects/9.bam_down/394_25_hb/hb_all"
    chunk_output_dir="/public/home/user/1.projects/9.bam_down/394_25_hb/chunk"
