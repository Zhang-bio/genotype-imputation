...
vcftools --gzvcf /public/home/user/1.projects/9.bam_down/22jc/Site22inds_hardfiltered.snp.vcf.gz--max-missing 0.9 --maf 0.05 --hwe 1e-6 --minDP 3 --recode --recode-INFO-all --stdout | bgzip -f > Site22inds_mindp3.vcf.gz

bcftools index -c Site22inds_mindp3.vcf.gz 
    ...
    java -Xmx40g -jar "$beagle_jar" nthreads=16 gt="Site22inds_mindp3.vcf.gz" out="Site22inds_mindp3_beagle_z" impute=true
    
    # Define input files and output folders

    n_input_vcf="/public/home/user/1.projects/9.bam_down/22jc/Site22inds_hardfiltered.snp.vcf.gz"
    n_output_folder="22_all"
...
#for sample_size in "${samples[@]}"; do
    ...
    chunk_input_dir="/public/home/user/1.projects/9.bam_down/22jc/22jc_mindp3/22_all"
    chunk_output_dir="/public/home/user/1.projects/9.bam_down/22jc/22jc_mindp3/chunk"
